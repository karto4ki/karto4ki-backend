...
type GoogleAuthService interface {
	Authenticate(ctx context.Context, idToken string) (jwt.Pair, error)
}

func GoogleAuth(service GoogleAuthService) gin.HandlerFunc {
	return func(c *gin.Context) {
		...
		pair, err := service.Authenticate(c.Request.Context(), req.IDToken)
		if err != nil {
			switch {
